<div>
    ...
    <!-- Hero Section (About) -->
    <div class="hero pt-20 pb-20 lg:py-36 bg-gradient-to-b from-teal-900 via-teal-800 to-teal-700 text-white">
        <div class="hero-content text-center">
            <div class="max-w-5xl">
                <h1 class="text-3xl lg:text-5xl font-bold mb-6">Tentang Kami</h1>
                <p class="mt-6 text-sm lg:text-lg leading-relaxed">
        ...
        <div class="hero-content text-center">
            <div class="max-w-2xl space-y-6">
                ...
                <div class="flex justify-center mt-6 space-x-4">
                    <a href="https://wa.me/6281234567890" class="btn btn-success text-white">
                    ...
                    <a href="mailto:nufaisyastore@gmail.com" class="btn btn-primary text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
