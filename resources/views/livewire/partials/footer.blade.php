        ...
        <div class="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div class="text-white">
                ...
                <ul class="mt-2 space-y-2">
                    ...
                    <li><a href="#" class="hover:text-primary">Order Status</a></li>
                    <li><a href="#" class="hover:text-primary">Payment Options</a></li>
                </ul>
            </div>
            ...
            <div class="text-white">
                ...
                <ul class="mt-2 space-y-2">
                    ...
                    <li><a href="#" class="hover:text-primary">Gamis</a></li>
                    <li><a href="#" class="hover:text-primary">Kacamata</a></li>
                </ul>
            </div>
        </div>
